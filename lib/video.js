...
module.exports = function (filePath, settings, infoConfiguration, infoFile,ffmpegBin) {
	...
	var execCommand = function (callback, folder) {
		...
		var finalCommands = [this.ffmpegBin' -i'] //use configuration path
